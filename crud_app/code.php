...
if(isset($_POST['ubah_data_siswa']))
{
    ...
    $query = "UPDATE siswa SET nama='$nama', email='$email', no_hp='$no_hp', jurusan='$jurusan', alamat='$alamat', hobi='$hobi' WHERE id='$id_siswa' ";
    $query_run = mysqli_query($con, $query);
...
if(isset($_POST['simpan']))
{
    ...
    $query = "INSERT INTO siswa (nama,email,no_hp,jurusan,alamat,hobi) VALUES
    ('$nama', '$email', '$no_hp', '$jurusan', '$alamat', '$hobi')";
